...
Version  : 6.11.0
Release  : 236
URL      : https://download.kde.org/stable/frameworks/6.11/kpackage-6.11.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.11/kpackage-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/kpackage-6.11.0.tar.xz.sig
...
%setup -q -n kpackage-6.11.0
cd %{_builddir}/kpackage-6.11.0
pushd ..
cp -a kpackage-6.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739574519
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Package.so.6.11.0
/usr/lib64/libKF6Package.so.6
/usr/lib64/libKF6Package.so.6.11.0
...
/usr/share/man/sl/man1/kpackagetool6.1
