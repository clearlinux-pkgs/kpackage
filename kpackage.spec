...
Source0  : https://download.kde.org/stable/frameworks/5.100/kpackage-5.100.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.100/kpackage-5.100.0.tar.xz.sig
...
%prep
%setup -q -n kpackage-5.100.0
cd %{_builddir}/kpackage-5.100.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670546440
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Package.so.5.100.0
